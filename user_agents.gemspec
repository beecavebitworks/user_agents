Gem::Specification.new do |s|
  ...
  s.files       = ["lib/user_agents.rb", "lib/ua/user_agent_details.rb", "lib/ua/user_agent_platforms.rb", "lib/ua/user_agent_part.rb", "lib/ua/user_agent_platform.rb", "lib/ua/user_agent_paren.rb" ]
  s.homepage    =
